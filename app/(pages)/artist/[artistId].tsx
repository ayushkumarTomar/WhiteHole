...
import { getArtistDetails, getPlaylistDetails } from '@/lib/api';
...
const ArtistScreen = () => {
  ...
  const imageLink50 = artistDetails.image;
  const imageLink = imageLink50.replace(/-(\d{3})x(\d{3})(?=\.\w+($|\?))/, "-500x500").replace("_50x50" , "_500x500").replace("_150x150" , "_500x500");
