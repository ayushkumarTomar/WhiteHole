...
import { View, Text, Modal, TouchableOpacity, TextInput, StyleSheet, Button } from "react-native";
...
interface PlayListModalProps {
  isVisible: boolean;
  onClose: () => void;
  onCreatePlaylist: (playlistName: string) => void; // Function to handle playlist creation
}
...
const PlayListModal: React.FC<PlayListModalProps> = ({ isVisible, onClose, onCreatePlaylist }) => {
  ...
  const handleCreatePlaylist = () => {
    if (playlistName.trim() !== "") {
      onCreatePlaylist(playlistName); // Trigger the function to create a playlist
